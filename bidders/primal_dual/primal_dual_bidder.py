...
class PrimalDualBidder(Bidder):
    ...
    def learn(self, f_t, c_t, m_t=None):
        ...
        # full feedback: estimate f(b) and c(b) for every bid of every campaign from the observed highest competing bids m_t,
        # instead of using only the bandit f_t and c_t
